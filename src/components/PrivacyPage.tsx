      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24">
          ...
          <div className="lg:w-[45%] lg:sticky lg:top-40 h-fit flex flex-col items-center lg:items-start text-center lg:text-left space-y-8 mb-16 lg:mb-0">
            ...
            <h1 className="privacy-reveal text-5xl md:text-7xl lg:text-[5.5vw] xl:text-7xl font-black tracking-tighter text-white leading-[0.9] uppercase italic overflow-visible">
